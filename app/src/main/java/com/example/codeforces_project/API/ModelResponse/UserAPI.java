package com.example.codeforces_project.API.ModelResponse;
...
public class UserAPI {
    ...
    public UserAPI(String handle, String email, String vkId, String openId, String firstName, String lastName, String country, String city, String organization, int contribution, String rank, int rating, String maxRank, int maxRating, long lastOnlineTimeSeconds, long registrationTimeSeconds, int friendOfCount, String avatar, String titlePhoto) {
        this.handle = handle;
        this.email = email;
        this.vkId = vkId;
        this.openId = openId;
